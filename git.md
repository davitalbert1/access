...
```bash
git remote add origin https://github.com/davitalbert1/access.git
```
...
```bash
git remote set-url origin git@github.com:davitalbert1/access.git
```

```bash
git remote add origin git@github.com:davitalbert1/access.git
```
...
```text
origin  git@github.com:davitalbert1/access.git (fetch)
origin  git@github.com:davitalbert1/access.git (push)
```
